...
public class ElementUtil {
  ...
  public void Search(By searchField, By suggestions, String searchKey, String suggName)
  ...
  public void doIndexElementClick(By locator, int index) {
  ...
  public void doIndexElementSend(By locator, int index, String path) {
    List<WebElement> optionsList = driver.findElements(locator);
    optionsList.get(index).sendKeys(path);
  }
  ...
  /**
   * This method is used to select the values from the drop down. It can select; 1. single selection
   * 2. Multiple selection 3. All Selection: please pass "all" as a value to select all the values
   *
   * @param locator
   * @param values
   */
  ...
  public void fourLevelMenuHandle(
      By parentMenuLocator,
      By firstChildMenuLocaor,
      By secondChildMenuLocaor,
      By thirdChildMenuLocaor)
      throws InterruptedException {
  ...
  public WebElement retryingElement(By locator, int timeOut) {
    ...
    if (element == null) {
      System.out.println(
          "element is not found....tried for "
              + timeOut
              + " times "
